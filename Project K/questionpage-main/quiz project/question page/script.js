var quizData = [
   ...
   function takeInput() {
      const questionInp = document.getElementById('questionInput').value;
      var optionsInp = [];
      const option1 = document.getElementById('option1').value;
      const option2 = document.getElementById('option2').value;
      const option3 = document.getElementById('option3').value;
      const option4 = document.getElementById('option4').value;
      optionsInp.concat([option1, option2, option3, option4]);
      const crctOption = document.getElementById('crctOption').value;
      const explanation = doument.getElementById('explanation').value;
      var obj = {question: questionInp,
        options: optionsInp,
        answer: crctOption,
